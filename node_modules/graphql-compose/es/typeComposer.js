...
var TypeComposer = function () {
  _createClass(TypeComposer, null, [{
    ...
    value: function create(opts) {
      ...
      if (isString(opts)) {
        ...
        // $FlowFixMe
        var _type = new GraphQLObjectType(_extends({}, opts, {
          fields: function fields() {
            return {};
          }
        }));
  ...
  _createClass(TypeComposer, [{
    ...
    value: function setFields(fields) {
      var prepearedFields = TypeMapper.convertOutputFieldConfigMap(fields, this.getTypeName());
    ...
    */
    ...
    value: function extendField(name, parialFieldConfig) {
      var fieldConfig = Object.assign({}, this.getField(name), parialFieldConfig);
    ...
    value: function buildRelations() {
      ...
      var names = Object.keys(this.getRelations());
    ...
    value: function addRelationRaw(fieldName, resolver, opts) {
      ...
      var argsConfig = Object.assign({}, resolverFieldConfig.args);
      var argsProto = {};
      var argsRuntime = [];
      ...
      var resolve = function resolve(source, args, context, info) {
        var newArgs = Object.assign({}, args, argsProto);
    ...
    value: function clone(newTypeName) {
      ...
      var cloned = new TypeComposer(new GraphQLObjectType({
        name: newTypeName,
        fields: newFields
      }));
