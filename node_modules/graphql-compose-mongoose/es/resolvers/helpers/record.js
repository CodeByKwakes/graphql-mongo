...
export var recordHelperArgs = function recordHelperArgs(typeComposer, opts) {
  ...
  var recordComposer = new InputTypeComposer(typeStorage.getOrSet(recordTypeName, typeComposer.getInputTypeComposer().clone(recordTypeName).getType()));
  ...
  return {
    record: {
      name: 'record',
      type: opts.isRequired ? new GraphQLNonNull(recordComposer.getType()) : recordComposer.getType()
    }
  };
};